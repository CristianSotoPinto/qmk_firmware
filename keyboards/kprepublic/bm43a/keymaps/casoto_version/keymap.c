...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
    ...
    [1] = LAYOUT(
        ...
        KC_LSFT, LCTL(KC_A),LCTL(KC_S),LCTL(KC_D),LCTL(KC_F),_______, KC_PGUP, KC_HOME, KC_UP,KC_END,_______,
